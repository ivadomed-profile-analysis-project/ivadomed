...
def main():
    ...
    config_files = [
        ...
        config_path_2x + 'unet_2xdata.json',
        # config_path_0_5x + '3dunet_0.5xdata.json',
    ...
    plt.savefig(plotdir + '2d_subplot.png')
    # plt.show()
    ...
    filename = plotdir + 'time_per_comp_2d_plot.png'
    ylabel = 'Time (seconds)'
    ...
    _0_5_val = pd.read_csv(final_path + 'unet_0.5/' + 'unet_0.5_val.csv')
    _1_val = pd.read_csv(final_path + 'unet_1.0/' + 'unet_1.0_val.csv')
    _2_val = pd.read_csv(final_path + 'unet_2.0/' + 'unet_2.0_val.csv')
    ...
    plt.savefig(plotdir + '3d_subplot.png')
    # plt.show()
    ...
    time_mean = [time_data, time_train, time_post]
    label = ['Data', 'Train', 'Post']
    filename = plotdir + 'time_per_comp_3d_plot.png'
    ylabel = 'Time (seconds)'
    title = 'Time per Pipeline Component Across Dataset Sizes'
    stackedbarplot(X=X, data=time_mean, label=label, width=2, ylabel=ylabel, title=title, filename=filename)
    ...
    _0_5_val = pd.read_csv(final_path + '3dunet_0.5/' + '3dunet_0.5_val.csv')
    _1_val = pd.read_csv(final_path + '3dunet_1.0/' + '3dunet_1.0_val.csv')
    _2_val = pd.read_csv(final_path + '3dunet_2.0/' + '3dunet_2.0_val.csv')
    ...
    ylabel = 'GPU Utilization (%)'
    title = 'Validation GPU Utilization Per Mini-Batch Across 3-D Dataset Sizes'
    trainsubplot(_0_5_val.iloc[:, 1], _1_val.iloc[:, 1], _2_val.iloc[:, 1], label, ylabel, title, 1)

    ylabel = 'CPU Utilization (%)'
    title = 'Validation CPU Utilization Per Mini-Batch Across 3-D Dataset Sizes'
    trainsubplot(_0_5_val.iloc[:, 2], _1_val.iloc[:, 2], _2_val.iloc[:, 2], label, ylabel, title, 2)

    ylabel = 'GPU Memory Utilization (%)'
    title = 'Validation GPU Memory Utilization Per Mini-Batch Across 3-D Dataset Sizes'
    trainsubplot(_0_5_val.iloc[:, 3], _1_val.iloc[:, 3], _2_val.iloc[:, 3], label, ylabel, title, 3)

    ylabel = 'CPU Memory Utilization (%)'
    title = 'Validation CPU Memory Utilization Per Mini-Batch Across 3-D Dataset Sizes'
    trainsubplot(_0_5_val.iloc[:, 4], _1_val.iloc[:, 4], _2_val.iloc[:, 4], label, ylabel, title, 4)
